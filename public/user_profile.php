...
$db=new Database();
$id=$_SESSION['id'];
$db->registerUserBank($id);
$profile=$db->usersearch($id);
$bank=$db->userbankdetails($id);
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    {
    if($db->updateUser($id,$name,$email,$flat,$building,$street,$area,$district,$state,$country,$PIN))
    {
        $db->updateUserBank($id,$account_number,$IFCS,$CBIN);
        header("refresh:0.1; url=user_profile.php");
    }
    }
}
?>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-6">
                                <div class="aa-myaccount-register">
                                    ...
                                    <form action="user_profile.php" method="POST" class="aa-login-form"
                                                    ...
                                                    <div id="collapseThree" class="collapse"
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="text" name="ifcs" placeholder="IFSC"
